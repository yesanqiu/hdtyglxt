...
public class SnUtil {
    ...
    public String snCal(String address, String ak, String sk) throws UnsupportedEncodingException,
        ...
        String paramsStr = snUtil.toQueryString(paramsMap);
